...
CREATE TABLE RESERVATIONS_j6j2liu
(
	rid INTEGER PRIMARY KEY,
	username VARCHAR(20) REFERENCES USERS_j6j2liu(username) NOT NULL,
	paid INTEGER,-- 1 means paid
	fid_1 int REFERENCES FLIGHTS(fid) NOT NULL,
	fid_2 int REFERENCES FLIGHTS(fid)
);
